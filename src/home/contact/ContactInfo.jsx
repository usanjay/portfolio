  ...
  return (
    <div className="flex flex-col gap-5 w-full md:w-[350px]">
      ...
      <a href="mailto:sanjaysharma51220@gmail.com">
        <div
          className="flex items-center gap-4 bg-white shadow-md px-5 py-4 rounded-lg
            bg-linear-to-r from-white to-white gradient-bg-hover text-gray-700 hover:text-white
            hover:scale-102 "
        >
      ...
      <a href="tel:+918627821746">
        <div
          className="flex items-center gap-4 px-5 py-4 rounded-lg shadow-md 
            bg-linear-to-r from-white to-white gradient-bg-hover text-gray-700 hover:text-white
            hover:scale-102"
        >
          <span className="text-xl">
